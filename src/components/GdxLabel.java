...
public class GdxLabel extends GdxAbstractComponent {
  private enum TextAlignment { LEFT, CENTER, RIGHT }
  private enum VerticalAlignment { TOP, MIDDLE, BOTTOM }
  ...
  public static final VerticalAlignment VALIGN_TOP = VerticalAlignment.TOP;
  public static final VerticalAlignment VALIGN_MIDDLE = VerticalAlignment.MIDDLE;
  public static final VerticalAlignment VALIGN_BOTTOM = VerticalAlignment.BOTTOM;
  ...
  public GdxLabel(float x, float y, float width, float height, float padding, CharSequence text, TextAlignment alignment, BitmapFont font) {
  ...
  public GdxLabel(float x, float y, float width, float height, float padding, CharSequence text, BitmapFont font) {
    this(x, y, width, height, padding, text, ALIGN_LEFT, font);
  }
  
  public GdxLabel(float x, float y, float width, float height, float padding, CharSequence text, TextAlignment alignment, String fontName) {
    super(x, y, width, height);
    this.padding = padding;
    this.alignment = alignment;
    this.text = text;
  ...
  public GdxLabel(float x, float y, float width, float height, float padding, CharSequence text, String fontName) {
    this(x, y, width, height, padding, text, ALIGN_LEFT, fontName);
  }
  
  public GdxLabel(float x, float y, float width, float height, float padding, CharSequence text, TextAlignment alignment) {
    this(x, y, width, height, padding, text, alignment, (String)null);
  }
  
  public GdxLabel(float x, float y, float width, float height, float padding, CharSequence text) {
